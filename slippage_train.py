...
Instruction:
    1. model
        # created by keras
        # "DNN test" is currently not functional
    2. modifying the reference trajectory can generate the different traning data
    3. the path must be generated by some rules
"""
